...
function HandleBrandSort(){
  var selected = document.querySelector("#Brand").value;
  // console.log(selected)

  var filtered = mensData.filter(function(el){
...
function HandlePriceSort(){
    var selected = document.querySelector("#SelectedPrice").value;
...
mensData.map(function(el){
    ...
    box.append(image,name,brand,pdiv);
